...
CREATE TABLE IF NOT EXISTS `file_managed` (
  ...
  KEY `file_type` (`type`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='Stores information for uploaded files.';
...
) ENGINE=InnoDB AUTO_INCREMENT=407 DEFAULT CHARSET=utf8 COMMENT='Contains the individual links within a menu.';
...
CREATE TABLE IF NOT EXISTS `queue` (
  ...
  KEY `expire` (`expire`)
) ENGINE=InnoDB AUTO_INCREMENT=94 DEFAULT CHARSET=utf8 COMMENT='Stores items in queues.';
...
) ENGINE=InnoDB AUTO_INCREMENT=663 DEFAULT CHARSET=utf8 COMMENT='Table that contains logs of all system events.';
